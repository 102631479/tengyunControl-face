...
-->
<template>
    <div style="padding: 50px 50px 205px; border: 1px solid #eee;" class=" flex justify-center bg-fff">
      ...
      <div style="border-left:1px solid #eee;width: 490px;color:#000" class="login_info pl-50 pt-70">
        ...
        <img width="100%" src="./../../../assets/images/login_position.png" alt="">
...
export default {
  ...
  mounted(){
      ...
      if (process.env.NODE_ENV === "development") {
        ...
        Cookies.set("token", '', { domain: ".zhihuiwenlvyun.com", path: "", expires: 7 });
      }
  },
  methods: {
    login() {
